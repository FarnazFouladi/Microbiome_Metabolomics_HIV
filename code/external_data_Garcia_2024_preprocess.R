...
# Load data
source("code/load.R")
expvec <- read_rds("data/external_dataset/Garcia_2024/PRJNA307231_Expvec_list_of_SummarizedExperiment_objects.rds")
# Taxonomies
...
saveRDS(gut_taxonomies, file = "data/external_dataset/Garcia_2024/taxonomies.rds")
...
# Metadata
meta <- read_csv("data/external_dataset/Garcia_2024/Garcia2024_data.csv") # 82 samples
...
out_dir <- file.path("data/external_dataset/Garcia_2024", "processed_data")
